...
severe.anxiety_t <- text_recode(var1= "f.2473.0.0", var2 = "f.2473.3.0",
                        text = "Yes", NAvals = "Prefer not to answer") 

table(severe.anxiety_t, useNA="ifany")
...
severe.anxiety <- ifelse(severe.anxiety_n==1|severe.anxiety_t==1,1, #This condition first
                ifelse(severe.anxiety_n==0|severe.anxiety_t==0,0,NA))
...
high.cholesterol <- ifelse(high.cholesterol_t1==1|h==-99999, NA)
